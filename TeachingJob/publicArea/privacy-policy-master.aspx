<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="privacy-policy-master.aspx.cs" Inherits="TeachingJob.publicArea.privacy_policy_master" ValidateRequest="false" %>
<%@ Register Assembly="CKEditor.NET" Namespace="CKEditor.NET" TagPrefix="CKEditor" %>

<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
<title>Edit privacy policy - TeachinVietnam</title>
</asp:Content>
