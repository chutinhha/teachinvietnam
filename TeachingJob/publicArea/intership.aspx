<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="intership.aspx.cs" Inherits="TeachingJob.publicArea.intership" %>
            ...
            <div class="intership">
                <div class="skyTestimonial">
                    <h2 class="heading-type huge-heading center contrast float-right">
                        Welcome to TeachinVietnam intership program</h2>
                </div>
                <div class="nav-icons">
                    <ul>
                ...
                <div class="simple-tabs-panel-container">
                    <ul id="tabs" class="heading-type regular vertical-tabs">
                        ...
                        <li class="simple-tab"><a href="#apply" runat="server" title="Apply intership program" >
                            <span>&raquo;Apply intership</span></a> </li>
                    ...
                    <div class="panel custom-simple-tab-panel full-width" id="apply">
                        <div class="inner">
                            <asp:Panel ID="pnl_ApplyAdd" runat="server" Visible="false" CssClass="postnew2">
                                <a href="#postnew-panel" name="postnew" onclick="postnewpanel()">
                                    <asp:Image ID="Image1" runat="server" ImageUrl="../images/icons/addicon.png" ToolTip="<%$Resources:Resource,PostnewArticle %>" /></a>
                            </asp:Panel>
                            <h5 class="heading-type large-heading green">Apply Intership Program</h5>
                            <hr />
                            <p>
                                <asp:Literal ID="literal_Body" runat="server">Content text here..</asp:Literal>
                            </p>
                        </div>
                    </div>
