<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ContactWithoutLogin.aspx.cs" Inherits="TeachingJob.memberArea.ContactWithoutLogin" %>
                ...
                <div id="">
                    ...
                    <div class="standard-form2">
                        <h3 class="group-title top">
                            <asp:Literal ID="Literal2" runat="server" Text="<%$Resources:Resource,QuickApply %>"></asp:Literal></h3>
                        <table>
                            <tr>
                                <td class="style2">
