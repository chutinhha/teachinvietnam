<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" EnableViewState="false"
    CodeBehind="JobSector.aspx.cs" Inherits="TeachingJob.publicArea.JobSector" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <title>Jobs by Sector - TeachinVietnam</title>
    ...
    <div class='editable-area span-12'>
        ...
        <div class='section'>
                ...
                <div class='component component-LatestJobs' id='c-5'>
                    <div class="module public-sector">
                        <div class="module-title">
                            <h2>
                                <asp:Literal ID="Literal1" runat="server" Text="<%$Resources:Resource,NewJobs %>"></asp:Literal></h2>
                        ...
                        <div id="All-tab" class="job-type-tab show">
                            <table class="latest-jobs public-sector">
                                ...
                                <asp:Repeater ID="Repeater_AllJobByAllSector" runat="server" OnItemDataBound="Repeater1_DataBound">
                                    <ItemTemplate>
            ...
            <div class='col span-4 last'>
                <div class='component component-Advert' id='c-2' cid='15120'>
                    <div class="module mpu  pagelets-module">
                        <div class="component-container">
                            <div class="advert  public-sector MPU">
                                <noscript>
                                    <a href="" target="_blank">
                                        <img src="" border="0" alt="" /></a></noscript>
                                <div id="dfp-0">
                                </div>
                                <!-- end ad tag -->
