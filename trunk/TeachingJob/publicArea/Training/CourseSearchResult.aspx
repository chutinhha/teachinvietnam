<%@ Page Title="" Language="C#" MasterPageFile="~/Training.Master" AutoEventWireup="true" CodeBehind="CourseSearchResult.aspx.cs" Inherits="TeachingJob.publicArea.Training.CourseSearchResult" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
<title>Training - TeachinVietnam</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="HeadContent" runat="server">
<link id="Link1" href="../../css/content.css" runat="server" rel="stylesheet" type="text/css" />
</asp:Content>
